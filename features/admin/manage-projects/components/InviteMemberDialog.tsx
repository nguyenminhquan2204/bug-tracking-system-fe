...
export default function InviteMemberDialog({
  ...
  const t = useTranslations('Admin.ManageProject.dialogs.inviteMemberDialog')
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[520px] space-y-6">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">{t('currentMembers')}</p>
                ...
                {existingMembers
                  ...
                  .map(member => (
                    ...
                    >
                      ...
                      <Badge variant="secondary">{t('tester')}</Badge>
                    </div>
                  ))}
              </div>
            </div>
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">{t('inviteNewMember')}</p>
          <Tabs
            defaultValue="tester"
            onValueChange={v => setActiveRole(v as Role)}
          >
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="tester">{t('tester')}</TabsTrigger>
